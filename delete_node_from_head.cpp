...
void delete_at_head_postion(Node *&head)
{
...
int main()
{
  ...
  while (true)
  {
    ...
    cout << "Opation 5: Delete At a Postion" << endl;
    cout << "Opation 6: Delete At head Postion" << endl;
    cout << "Opation 7: terminate" << endl;
    int opstion;
    cin >> opstion;
    ...
    else if (opstion == 5)
    {
      ...
      delete_at_postion(head, postion);
    }
    else if (opstion == 6)
    {

      delete_at_head_postion(head);
    }
